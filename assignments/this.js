...
* 4. We can use "call" and "apply" as ways to redirect "this" in the direction we want, invoking the method of the original object that we want to call or apply and then specifying the object we want to call or apply it to.
*
